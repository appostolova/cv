    ...
    return function a(b, c, d) {
        ...
        8: [function(a, b, c) {
            ...
            b.exports = function(b, c) {
                ...
                return n.watch = function() {
                    ...
                    n.sheets = [];
                    for (var b = 0; b < a.length; b++)("stylesheet/less" === a[b].rel || a[b].rel.match(/stylesheet/) && a[b].type.match(t)) && n.sheets.push(a[b])
                        ...
                        parsers: n = {
                            ...
                            entities: {
                                ...
                                variableCurly: function() {
                                    var a, b = o.i;
                                    if ("@" === o.currentChar() && (a = o.$re(/^@\{([\w-]+)\}/))) return new e.Variable("@" + a[1], b, c)
                                },
                                color: function() {
                                    var a;
                            ...
                            element: function() {
                                var a, b, d, f = o.i;
                                if (b = this.combinator(), a = o.$re(/^(?:\d+\.\d+|\d+)%/) || o.$re(/^(?:[.#]?|:*)(?:[\w-]|[^\x00-\x9f]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/) || o.$char("*") || o.$char("&") || this.attribute() || o.$re(/^\([^&()@]+\)/) || o.$re(/^[\.#:](?=@)/) || this.entities.variableCurly(), a || (o.save(), o.$char("(") ? (d = this.selector()) && o.$char(")") ? (a = new e.Paren(d), o.forget()) : o.restore("Missing closing ')'") : o.forget()), a) return new e.Element(b, a, f, c)
                            },
                            combinator: function() {
                                var a = o.currentChar();
                                if ("/" === a) {
                            ...
                            atomicCondition: function() {
                                var a, b, c, d, f = this.entities,
                                    g = o.i;
                                if (a = this.addition() || f.keyword() || f.quoted()) return o.$char(">") ? d = o.$char("=") ? ">=" : ">" : o.$char("<") ? d = o.$char("=") ? "<=" : "<" : o.$char("=") && (d = o.$char(">") ? "=>" : o.$char("<") ? "=<" : "="), d ? (b = this.addition() || f.keyword() || f.quoted(), b ? c = new e.Condition(d, a, b, g, (!1)) : i("expected expression")) : c = new e.Condition("=", a, new e.Keyword("true"), g, (!1)), c
                            },
                            operand: function() {
                                var a, b = this.entities;
                                o.peek(/^-[@\(]/) && (a = o.$char("-"));
                            ...
                            ruleProperty: function() {
                                ...
                                for (a(/^(\*?)/);;)
                                    if (!a(/^((?:[\w-]+)|(?:@\{[\w-]+\}))/)) break;
                                if (f.length > 1 && a(/^((?:\+_|\+)?)\s*:/)) {
                                    for (o.forget(), "" === f[0] && (f.shift(), g.shift()), d = 0; d < f.length; d++) b = f[d], f[d] = "@" !== b.charAt(0) ? new e.Keyword(b) : new e.Variable("@" + b.slice(2, -1), g[d], c);
                                    return f
                                }
                                o.restore()
                            }
        ...
        50: [function(a, b, c) {
            ...
            h.prototype = new f, h.prototype.type = "Color", h.prototype.luma = function() {
                ...
                for (var d = [], e = this.alpha * (1 - c.alpha) + c.alpha, f = 0; f < 3; f++) d[f] = this._operate(a, b, this.rgb[f], c.rgb[f]);
                return new h(d, e)
            ...
            var d = a("./node"),
                ...
                g = function(a, b, c, d, f, g, h, i) {
                    ...
                    if (this.name = a, this.value = b, c)
                        for (Array.isArray(c) ? this.rules = c : (this.rules = [c], this.rules[0].selectors = new e([], null, null, this.index, f).createEmptySelectors()), j = 0; j < this.rules.length; j++) this.rules[j].allowImports = !0;
            ...
            m.prototype = new d, m.prototype.type = "Ruleset", m.prototype.isRuleset = !0, m.prototype.isRulesetLike = !0, m.prototype.accept = function(a) {
                ...
                if (g && (c = g.length)) {
                    for (b = [], k.error({
                        ...
                        }), f = 0; f < c; f++) d = g[f].eval(a), b.push(d), d.evaldCondition && (h = !0);
                    k.reset()
                } else h = !0;
                ...
                for (f = 0; f < s; f++) "MixinCall" === r[f].type ? (n = r[f].eval(a).filter(function(a) {
                ...
                for (f = 0; f < r.length; f++)
                    if (i = r[f], i instanceof m && i.selectors && 1 === i.selectors.length && i.selectors[0].isJustParentSelector()) {
                        r.splice(f--, 1);
                        for (var u = 0; u < i.rules.length; u++) l = i.rules[u], l.copyVisibilityInfo(i.visibilityInfo()), l instanceof e && l.variable || r.splice(++f, 0, l)
                    }
                ...
                var k, m = a.compress ? "" : Array(a.tabLevel + 1).join("  "),
                    ...
                    o = 0,
                    p = 0;
                for (d = 0; d < this.rules.length; d++) g = this.rules[d], "Comment" === g.type ? (p === d && p++, j.push(g)) : g.isCharset && g.isCharset() ? (j.splice(o, 0, g), o++, p++) : "Import" === g.type ? (j.splice(p, 0, g), p++) : j.push(g);
                if (j = i.concat(j), !this.root) {
                    ...
                    for (k = a.compress ? "," : ",\n" + n, d = 0; d < s; d++)
                        if (h = r[d], q = h.length)
                            for (d > 0 && b.add(k), a.firstSelector = !0, h[0].genCSS(a, b), a.firstSelector = !1, e = 1; e < q; e++) h[e].genCSS(a, b);
                    b.add((a.compress ? "{" : " {\n") + m)
                }
                ...
                function k(a, b) {
                    ...
                    if (0 !== a.length) {
                        ...
                        for (c = 0; c < b.length; c++) d = b[c], d.length > 0 ? d[d.length - 1] = d[d.length - 1].createDerived(d[d.length - 1].elements.concat(a)) : d.push(new f(a))
                    }
                }
                ...
                function l(a, b, c) {
                    ...
                    for (k(o, p), h = 0; h < p.length; h++) t = p[h].length, t > 0 && (a.push(p[h]), u = p[h][t - 1], p[h][t - 1] = u.createDerived(u.elements, c.extendList));
                    return v
                }
        ...
        90: [function(a, b, c) {
            ...
            g.prototype = {
                ...
                _mergeRules: function(a) {
                    if (a) {
                        for (var b, c, e, f = {}, g = 0; g < a.length; g++) c = a[g], c instanceof d.Rule && c.merge && (e = [c.name, c.important ? "!" : ""].join(","), f[e] ? a.splice(g--, 1) : f[e] = [], f[e].push(c));
